...
%cameraPosition = cameraPosition * 150 / (cameraPosition(3));
%cameraPosition(1:2) = -cameraPosition(1:2)

%--------------------------------------------------------------------------
figure();
facade_3 = [0 0 0; 0 0 LONG_REAL ; 0 SHORT_REAL 0; 0 SHORT_REAL LONG_REAL];
facade_2 = [0 0 0; DEPTH_REAL 0 0 ; DEPTH_REAL 0 LONG_REAL; 0 0 LONG_REAL];
facade_4 = [0 SHORT_REAL 0; DEPTH_REAL SHORT_REAL 0 ; DEPTH_REAL SHORT_REAL LONG_REAL; 0 SHORT_REAL LONG_REAL];

facade_3_pos = [0 SHORT_REAL/2 LONG_REAL/2 10 SHORT_REAL LONG_REAL 0 0 0];
facade_2_pos = [DEPTH_REAL/2 0 LONG_REAL/2 10 DEPTH_REAL LONG_REAL 0 0 90];
facade_4_pos = [DEPTH_REAL/2 SHORT_REAL LONG_REAL/2 10 DEPTH_REAL LONG_REAL 0 0 90];
facade_1_pos = [DEPTH_REAL -SHORT_REAL/2 LONG_REAL/2 10 SHORT_REAL LONG_REAL 0 0 0];
facade_5_pos = [DEPTH_REAL 3*SHORT_REAL/2 LONG_REAL/2 10 SHORT_REAL LONG_REAL 0 0 0];
